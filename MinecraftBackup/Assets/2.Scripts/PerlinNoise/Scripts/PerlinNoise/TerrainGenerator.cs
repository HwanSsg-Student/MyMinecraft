...
public class TerrainGenerator : MonoBehaviour
{
    ...
    public Transform viewer;                //Viewer의 위치
    ...
    public void InitTerrainGenerator()
    {
        ...
        m_isCompleted = true;
        float maxViewDst = thresholdInfos[thresholdInfos.Length - 1].visibleDstThreshold;   //최대 가시거리
        chunkWorldSize = m_blockSettings.WorldSize;
        chunksVisibleInViewDst = Mathf.RoundToInt(maxViewDst / chunkWorldSize); //청크가 보이는 범위
        UpdateVisibleChunks();
    }
